                            ...
                            <form class="form-horizontal" action="charitable_programs/charitable_program_save" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea name="text_on_banner" type="text" class="form-control summernote" value=""><?php echo (!empty($query->text_on_banner)) ? $query->text_on_banner : ''; ?>  </textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea name="bottom_description" type="text" class="form-control summernote" value=""><?php echo (!empty($query->bottom_description)) ? $query->bottom_description : ''; ?>  </textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-md-3 control-label" for="form-field-4">Enter Amount of Field 2</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-md-3 control-label" for="form-field-4">Enter Amount of Field 3</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-md-3 control-label" for="form-field-4">Enter Amount of Field 4</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-md-3 control-label" for="form-field-4">Enter Amount of Field 5</label>
                                    <div class="col-sm-10">
