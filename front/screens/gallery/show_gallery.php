                            ...
                            <div class="product">
                              <div class="product-header">
                                ...
                                <div class="thumb image-swap">
                                  <a href="<?php echo 'gallery/gallery_images/'.$gallery->gallery_id .'/'. $gallery->category_id; ?>"><img src="<?php echo GALLERY_UPLOAD_PATH . $gallery->category_img_path  ; ?>" class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="<?php echo $gallery->gallery_name; ?>"></a>
                                  <a href="<?php echo 'gallery/gallery_images/'.$gallery->gallery_id .'/'. $gallery->category_id; ?>"><img src="<?php echo GALLERY_UPLOAD_PATH . $gallery->category_img_path; ?>" class="product-hover-image img-responsive img-fullwidth" width="300" height="300" alt="<?php echo $gallery->gallery_name; ?>"></a>
                              ...
                              <div class="product-details">
                                ...
                                <h5 class="product-title"><a href="<?php echo 'gallery/gallery_images/'.$gallery->gallery_id .'/'. $gallery->category_id; ?>"><?php echo $gallery->gallery_name; ?></a></h5>
