<div class="container mt-30">
        <div class="section-content">
          ...
          <?php }else{ ?>
            ...
            <div class="col-md-12">
            <div class="title-wrapper mb-1 text-center">
              <h6 class="subtitle line-shape-bottom line-shape-center text-theme-colored1">Gallery Categories</h6>
                            ...
                            <div class="product">
                              <div class="product-header">
                                ...
                                <div class="thumb image-swap">
                                  <a href="<?php echo 'gallery/show_gallery/'.$gallery->category_id; ?>"><img src="<?php echo GALLERY_IMG_UPLOAD_PATH . $gallery->gallery_img; ?>" class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="<?php echo $gallery->category_name; ?>"></a>
                                  <a href="<?php echo 'gallery/show_gallery/'.$gallery->category_id; ?>"><img src="<?php echo GALLERY_IMG_UPLOAD_PATH . $gallery->gallery_img; ?>" class="product-hover-image img-responsive img-fullwidth" width="300" height="300" alt="<?php echo $gallery->category_name; ?>"></a>
                              ...
                              <div class="product-details">
                                ...
                                <h5 class="product-title"><a href="<?php echo 'gallery/show_gallery/'.$gallery->category_id; ?>"><?php echo $gallery->category_name; ?></a></h5>
