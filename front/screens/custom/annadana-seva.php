...
<div class="container my-5">
    <div class="row">
        <div class="col-md-12 col-lg-6">
            <p>Each meal costs ₹15 and we require around ₹15,00,000 – ₹18,00,000 to provide food for a month. Your kind contribution will help us continue to provide free, nutritious food to needy people and temple devotees. </p>
            <ul>
              <li>
                
    Lord Varaha says in the Varaha Purana, “One who gives food, gives all that is worth giving in this world.”
              </li>
              <li>
                
    The Taittriya Upanishad says, “Do not send away anyone who comes to your door, without offering him food and hospitality.”

              </li>
            </ul>
            <p >At Hare Krishna Mandir Ahmedabad, we offer prasadam food to all visitors and the poor people residing in the surrounding areas of the temple, irrespective of caste, religion, gender, occupation or age</p>
           
            <h3 class="widget-title line-bottom">Our Annadana Programme </h3>
            <p >It is our continuous endeavour to serve free and nutritious food to as many people as possible. </p>

            <ul>
                <li>Beneficiaries: Needy people in the vicinity of the temple and temple visitors </li>
	<li>Meal menu: Khichadi, dal, roti, sabji, rice </li>
    <li> Number of people served every week: 25,000 – 30,000</li> 
	<li>Number people served since inception : 1.1 crore</li>
            ...
            <div class="section-content">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                  ...
                  <form id="popup_paypal_donate_form_onetime_recurring" action="<?php echo base_url('annadana-seva'); ?>"  method="POST" enctype="multipart/form-data">
