            ...
            <div slot="after">
              <div id="form-footer" class="">
                ...
                <div class="form-footer-payment">
                  ...
                  <button id="form-submit" type="submit" class="btn btn-flat btn-theme-colored mt-10 pl-30 pr-30 main-btn">Pay <span style="margin-left: 4px;">₹ <span id="pay-amount">0</span>.00</span></button>
                  <!---->
                </div>
              </div>
            </div>
        ...
        <div class="the-tech-box">
          <div class="the-tech-item">
            <h5 class="widget-title line-bottom">Festival Schedule</h5>
                <?php echo $page_items->schedule_content; ?>
            <h5 class="widget-title line-bottom"><?php echo $page_items->festival_title; ?></h5>
                <?php echo $page_items->festival_description; ?>
          </div>
...
$(document).ready(function(){
  ...
  messages : {
    ...
    submitHandler: function(form) {
      // e.preventDefault();  
      if($('#pay-amount').html() < 300 || $('#pay-amount').html() == '' ){
