...
<section data-tm-bg-color="#f5f5f4">
  <div class="container pt-0 pt-lg-20 pb-40">
    <div class="section-content">
      <div class="row">

      <div class="col-lg-4">
            <div class="tm-sc-project-items project-items-current-theme-style1 text-center pb-md-30">
...
<section style="background: #ececeb;">
  ...
  <!-- <div class="tm-floating-objects d-none d-xl-block">
    <span class="floating-object-1 tm-animation-floating"  data-tm-width="220" data-tm-height="198" data-tm-top="-70" data-tm-bottom="auto" data-tm-left="85" data-tm-right="auto" data-tm-opacity="1"></span>
...
<section>
  ...
  <div class="tm-floating-objects">
    ...
    <span class="floating-object-1 tm-animation-floating z-index--1 d-none d-xl-block" data-tm-bg-img="" data-tm-width="76" data-tm-height="123" data-tm-top="140" data-tm-bottom="auto" data-tm-left="220" data-tm-right="auto" data-tm-opacity="1"></span>
 ...
 <!-- Section: News -->
     <section data-tm-bg-color="#f5f5f4">
      <div class="container pb-110">
        <div class="section-content">
          <div class="row">
            <div class="col-lg-12 offset-xl-0 col-xxl-12 offset-xxl-0 mb-3">
              <div class="tm-sc-section-title section-title text-start mb-0 mb-xl-60 mb-xl-50 pr-60 pr-lg--0">
                <div class="title-wrapper mb-0">
                  <h6 class="subtitle line-shape-bottom line-shape-center text-center text-theme-colored1">Latest Blogs</h6>
            ...
            <div class="col-xxl-8">
              <div class="blog-carousel-current-theme-style1">
                ...
                <div class="blog-current-theme-style3">
                    <article class="post">
                      ...
                      <div class="entry-content bg-white p-2">
